...
//   Ads account → Goals → Conversions → New conversion action → Website
//   Copy the Conversion ID (AW-XXXXXXXXX) and Conversion label
//
// GOOGLE_ADS_ID    = your Google Ads account tag  e.g. "AW-123456789"
// CONVERSION_LABEL = your conversion action label e.g. "AbCdEfGhIjKlMnOp"
//
...
export default function ThankYouPage() {
  const gtagId = GOOGLE_ADS_ID;
  const conversionSend = `${GOOGLE_ADS_ID}/${CONVERSION_LABEL}`;
  ...
  return (
    <>
      ...
      {/* Conversion event — fires on thank-you page load = book request conversion */}
      <Script id="gtag-conversion" strategy="afterInteractive">
        {`
          gtag('event', 'conversion', { 'send_to': '${conversionSend}' });
        `}
      </Script>
      ...
      <main style={{ background: "#fff", minHeight: "100vh", color: "#0f172a", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <div style={{ maxWidth: 480, margin: "0 auto", padding: "40px 20px 24px" }}>
          ...
          <p style={{ fontSize: 13, fontStyle: "italic", color: "#6b7280", margin: "20px 0 28px", lineHeight: 1.55 }}>
            → Can&apos;t find the email? Check your spam folder and mark it &ldquo;Not Spam&rdquo; — this helps future emails reach you.
          </p>
